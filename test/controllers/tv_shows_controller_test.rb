...
class TvShowsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tv_show" do
    assert_difference('TvShow.count') do
      post tv_shows_url, params: { tv_show: { channel_id: @tv_show.channel_id, name: @tv_show.name, time: @tv_show.time } }
    end
  ...
  test "should update tv_show" do
    patch tv_show_url(@tv_show), params: { tv_show: { channel_id: @tv_show.channel_id, name: @tv_show.name, time: @tv_show.time } }
